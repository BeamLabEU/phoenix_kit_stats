defmodule PhoenixKitStats.ActivityLogAssertions do
  @moduledoc """
  Helpers for asserting activity log entries landed with the right
  action, module, and metadata shape.

  Imported into `PhoenixKitStats.DataCase` and `PhoenixKitStats.LiveCase`
  ...
  ## Example
      ...
      assert_activity_logged("stats_group.created", metadata_has: %{"key" => "server1"})
  """
